...
from data_loader import setup_data_loaders, CELEBA_EASY_LABELS
from data_loader import CELEBACached
...
def main(args):
    ...
    cc_vae.latent_walk(img[3], 'data/output')
    return 

def parser_args(parser):
    parser.add_argument('--cuda', action='store_true',
                        help="use GPU(s) to speed up training")
    parser.add_argument('-n', '--num-epochs', default=2, type=int,
